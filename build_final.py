...
# ── 5 tags ──
html_v = '<script>\n(function(){\n  var a = \'{{regex - legal region archetype}}\';\n  if(a === \'none\') return;\n\n  var customText = \'{{lookup - silktide banner description}}\';\n\n  // Load Silktide JS dynamically, then override banner text via DOM\n  var s = document.createElement(\'script\');\n  s.src = \'https://cdn.jsdelivr.net/gh/silktide/consent-manager@v2.0.1/silktide-consent-manager.js\';\n  s.onload = function(){\n    // Try official init() first\n    if(window.silktideConsentManager && window.silktideConsentManager.init){\n      window.silktideConsentManager.init({\n        mode: \'{{lookup - silktide mode}}\',\n        text: { title: \'Privacy Settings\', description: customText },\n        consentTypes: [\n          { id: \'analytics\', label: \'Analytics\', gtag: \'analytics_storage\' },\n          { id: \'advertising\', label: \'Marketing\', gtag: [\'ad_storage\',\'ad_user_data\',\'ad_personalization\'] }\n        ],\n        options: { expandedByDefault: a === \'strict-opt-in\' }\n      });\n    }\n    // Fallback: DOM override after 800ms\n    setTimeout(function(){\n      var el = document.querySelector(\'[class*=\"consent\"] p, [class*=\"banner\"] p, .stcm-description\');\n      if(!el) el = document.querySelector(\'[class*=\"stcm\"] p:first-of-type\');\n      if(el && customText) el.textContent = customText;\n    }, 800);\n  };\n  document.head.appendChild(s);\n})();\n</script>'
